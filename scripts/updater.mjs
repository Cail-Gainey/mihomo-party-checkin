...
changelog += '\n#### macOS 11+：\n\n'
changelog += `- PKG：[Intel](${downloadUrl}/mihomo-party-checkin-macos-${version}-x64.pkg) | [Apple Silicon](${downloadUrl}/mihomo-party-checkin-macos-${version}-arm64.pkg)\n\n`
changelog += '\n#### macOS 10.15+：\n\n'
changelog += `- PKG：[Intel](${downloadUrl}/mihomo-party-checkin-catalina-${version}-x64.pkg) | [Apple Silicon](${downloadUrl}/mihomo-party-checkin-catalina-${version}-arm64.pkg)\n\n`
changelog += '\n#### Linux：\n\n'
